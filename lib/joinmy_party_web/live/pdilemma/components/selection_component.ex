defmodule PdilemmaWeb.SelectionComponent do
  ...
  def selection_button(assigns) do
    ...
    <button phx-click="change_selection"
      class={"flex-1 my-3 max-w-sm mx-auto shadow-slate-400 shadow-md rounded-2xl px-4 aspect-square text-gray-100 font-bold text-3xl border-r-4 border-b-4 " <> if @selection == :cooperate do "border-green-700 bg-green-500" else "border-red-700 bg-red-500" end}
    >
